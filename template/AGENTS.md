...
| Handling credentials/tokens that flow through the LLM — `secret` tag, `c.Mask` / `c.MaskIgnoreCase`, `wick_enc_` tokens | [`encrypted-fields`](./.claude/skills/encrypted-fields/SKILL.md) |
